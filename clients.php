    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper" class="shadow">
            <ul class="sidebar-nav" style="padding-top: 10%;">
                ...
                <li class="space">
                    <a href="#" class="menu-kerning"><i class="fa fa-building-o gray" aria-hidden="true"></i> &nbsp;CLIENTS</a>
                </li>
                <li class="space">
                ...
                <li class="space">
                    <a href="#" class="menu-kerning"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;EMPLOYEES</a>
                </li>
                <li>
                    &nbsp;
                </li>
